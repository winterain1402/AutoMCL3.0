...
from .reg_model_optimizer import RegOptimizer
...
class XGBTuner(ModelBasedTuner):
    ...
    def __init__(self, task, plan_size=64,
                 ...
                 optimizer='reg', diversity_filter_ratio=None, log_interval=50):
        ...
        if optimizer == 'reg':
            optimizer = RegOptimizer(task, log_interval=log_interval)
        else:
